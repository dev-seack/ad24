            ...
            value: function() {
              (this.prototype.Emitter = Emitter),
                ...
                (this.prototype.defaultOptions = {
                  ...
                  renameFile: null,
                  forceFallback: !1,
                  dictDefaultMessage: "Bilder hier fallen lassen od",
                  dictFallbackMessage:
              ...
              value: function(a) {
                if ("FORM" === this.element.tagName)
                  for (
                    ...
                    if (
                      (g && (g = g.toLowerCase()), void 0 !== f && null !== f)
                    )
...
function onDropzoneSubmit(dropzone, formSelector) {
  $(document).on("click", formSelector + ' button[type="submit"]', (e) => {
  ...
  $(document).on("submit", formSelector, (e) => {
    ...
    dropzone.on("sendingmultiple", (data, xhr, formData) => {
      formArray = $(formSelector).serializeArray();
    ...
    if (dropzone.getAcceptedFiles().length > 0) {
      ...
      if (dropzone.options.url === "/person-registrieren") {
        //manually send form (multipart)
        ...
        $.ajax({
          ...
          contentType: false,
          processData: false,
          method: dropzone.options.method,
          type: dropzone.options.method,
          success: function(data) {
            $(".iziToast").each(function() {
              iziToast.hide({}, this);
            });
            iziToast.success({
              title: "Erfolgreich!",
              message: "Deine Anfrage wurde bearbeitet",
              color: "green",
              position: "center",
              overlay: true
            });
        ...
        iziToast.warning({
          title: "Achtung!",
          message: "Du hast keine Bilder eingefügt",
...
Dropzone.options.personDropzone = {
  url: "/person-registrieren",
  ...
  acceptedFiles: "image/*",
  addRemoveLinks: true,
  dictDefaultMessage: "Bilder hier fallen lassen oder klicken",
  init: function() {
    onDropzoneSubmit(this, "#formDropzone");
  }
};

Dropzone.options.companyDropzone = {
  url: "/handwerker-registrieren",
  autoProcessQueue: false,
  uploadMultiple: true,
  parallelUploads: 5,
  maxFiles: 5,
